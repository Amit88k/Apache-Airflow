For a scheduling a spark job using Airflow, a dag named 'scheduling_spark_using_airflow is created which python script  calling_spark_job_dag.py contains. Dag is scheduled to run once. 
